...
>
> 最后同步 HEAD: 43961d5（2026-08-26，Windows 机：内核子模块升级 dsh-v0.1.1-rc.2（rc.5 后 854 笔）——Gemini 热修重放 + shims 补 homedir/sha256 + 三端 harness.js 重打包 SHA256 一致，门禁全绿，CI 三端验证中）
